  ...
  return (
    ...
    >
      ...
      >
        ...
        <a
          className="group bg-white px-7 py-3 flex items-center gap-2 rounded-full outline-none focus:scale-110 hover:scale-105 active:scale-103 transition cursor-pointer borderBlack dark:bg-white/10"
          href="/Tushar_Balar_CV.pdf"
          download
        >
          Download CV{" "}
        ...
        <a
          ...
          href="https://www.linkedin.com/in/tushar-balar-6094b282/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/Tusharbalar"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
